...
open(F3,">".$ref_seq."_Positive_Coupling");
open(F4,">".$ref_seq."_Negative_Coupling");
...
print "\nPlease check the ".$ref_seq."_Positive_Coupling for Positive Coupling\n";
print "\nPlease check the ".$ref_seq."_Negative_Coupling for Negative Coupling\n";
